function start() {
    ...
    months.forEach(printFunction);


    function printFunction(value) {
        /*console.log(value); used for debugging */
        var output = "";
    ...
    fruits.push("Banana", "Pomegranate");
    document.getElementById("fruits").innerHTML = fruits;

    // use the shift function to add a fruit to the front of the list and print to the fruits2 paragraph
    fruits.unshift("Lemon") /* The shift function removes the first one, the unshift adds one to the front */
    ...
    numbers.sort(function(a, b){return a - b}); /* I put them in ascending order */
